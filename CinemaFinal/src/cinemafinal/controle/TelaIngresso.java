...
import cinemafinal.controle.TelaCompra;
...
public class TelaIngresso extends javax.swing.JFrame {
    ...
    private String condicaoInfo;
    private String assentoInfo;
    private String filmeInfo;
  
  
    
    public TelaIngresso(String valor, String condicao, String assento, String filme) {
        initComponents();
        this.valorInfo = valor;
        this.condicaoInfo = condicao;
        this.assentoInfo = assento;
  ...
  public void setInfos(){
      jLabel8.setText(valorInfo);
      jLabel9.setText(condicaoInfo);
      jLabel10.setText(assentoInfo);
      jLabel11.setText(filmeInfo);
  }
  ...
  public static void main(String args[]) {
    java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            // Substitua pelos valores reais ou use variáveis apropriadas
            new TelaIngresso("20.00", "Confirmado", "A1", "Avatar 2").setVisible(true);
        }
    });
}
