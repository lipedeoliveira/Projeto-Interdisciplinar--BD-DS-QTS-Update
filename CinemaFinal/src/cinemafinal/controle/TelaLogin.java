...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
             String pesquisa = "select * from funcionario where Nome like '" + jTextField1.getText() + "'&&Senha="+jTextField2.getText()+"";
             con_cinema.executaSQL(pesquisa);
             
             if(con_cinema.resultset.first()){
                 TelaMenu menu = new TelaMenu();
                 menu.setVisible(true);
                 dispose();
             }
             else {
                 JOptionPane.showMessageDialog(null, "\n Usuário Não Registrado","", JOptionPane.INFORMATION_MESSAGE);
                 System.exit(0);
             }
        }catch(SQLException errosql) {
            JOptionPane.showMessageDialog(null,"\n Dados Não Localizados" +errosql,"", JOptionPane.INFORMATION_MESSAGE);
        }
