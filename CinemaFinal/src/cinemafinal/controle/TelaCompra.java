...
public class TelaCompra extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String filmeS = jList1.getSelectedValue();
        String valorIn = jTextField2.getText();
        String condicaoIn = jTextField1.getText();
        String assentoEs = "";
        
        if (jButton2.isEnabled() && jButton2.getBackground().equals(new java.awt.Color(255, 51, 51))) {
        assentoEs = "A3";
    } else if (jButton3.isEnabled() && jButton3.getBackground().equals(new java.awt.Color(255, 51, 51))) {
        assentoEs = "J7";
    } else if (jButton4.isEnabled() && jButton4.getBackground().equals(new java.awt.Color(255, 51, 51))) {
        assentoEs = "C5";
    } else if (jButton5.isEnabled() && jButton5.getBackground().equals(new java.awt.Color(255, 51, 51))) {
        assentoEs = "E12";
    }
        
   TelaIngresso ingresso = new TelaIngresso(valorIn, condicaoIn, assentoEs, filmeS);
